...
if ($currentPath.Path -like "*JobTrackerDB*") {
    Write-Host "✅ This appears to be the integrated terminal (in JobTrackerDB directory)" -ForegroundColor Green
} else {
    Write-Host "⚠️  This terminal is not in the JobTrackerDB directory" -ForegroundColor Yellow
